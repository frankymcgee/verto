          ...
          >
            ...
            >
              <div
                ...
                "
                class="rounded-4 border-2 p-2 cursor-pointer"
                :class="[
              ...
              >
                <div
                  class="truncate mb-1.5 pointer-events-none text-base-medium"
                >
                  {{ shift["shift_type"] }}
                </div>
                <div
...
const shiftBorderColor = (shift: Shift, dayDate: string) => {
  ...
  return hoveredCell.value.shift === shift.name &&
    hoveredCell.value.date === dayDate
