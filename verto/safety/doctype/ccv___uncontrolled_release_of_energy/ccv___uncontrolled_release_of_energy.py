...
class CCVUncontrolledReleaseofEnergy(Document):
    def validate(self):
    ...
    def mobile_field_change(self, changed_fieldname=None):
        ...
        rules to the in-memory document and returns the changed values that
        the Vue form should merge back into its local form state.
        """
        updates = {}
